...
public class InstalledAppListFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootViw = inflater.inflate(R.layout.fragment_installed_app, null);
        return rootViw;
    }
    ...
    private class ListInstalledAppAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder.imageUninstall = (ImageView)convertView.findViewById(R.id.img_uninstall);
            ...
            holder.imageUninstall.setOnClickListener(new OnClickListener() {

                @Override
                public void onClick(View v) {
                    startActivity(appInfo.getDeleteIntent(applicationContext));
                }
            });
